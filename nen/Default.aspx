...
<%--<%@ Register Src="~/mai_bao_cao/cms/display/DisplayLoadControl.ascx" TagPrefix="uc2" TagName="DisplayLoadControl" %>--%>
...
<head runat="server">
    ...
    <link href="css/index(moi1).css" rel="stylesheet" />
            ...
            <div id="timkiem">
                ...
                <div class="timkiemphai">
                    ...
                    <div class="hotline">
                        ...
                        <div class="number">0378302277 - 0325832299</div>
                    </div>
                    <div class="otimkiem">
                        <div class="search">
                            <div id="searchForm">
        ...
        <div class="contener">
            <div id="trangtrai">
                ...
                <div id="hotro">
                   <div id="pichotro">
                        <div class="logohotro">
                            <img src="css/images/1.png" title="pichtro" />
                        </div>
                    ...
                    <div class="support">
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Yến Nhi</span>
                                <br />                    
                                <span class="phone">0378302277</span>
                            </p>    
                        ...
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Hoàng Tỷ</span>
                                <br />
                                <span class="phone">0325832299</span>
           ...
           <%--         <div class="thongtinnganhang">
            ...
            <div id="trangphai">
                ...
                <%--<uc2:DisplayLoadControl runat="server" ID="DisplayLoadControl1" />--%>
                <uc1:DisplayLoadControl runat="server" ID="DisplayLoadControl" />
        ...
        <div class="contener">
            <div class=" menufoter">
                <p>Bộ môn Công nghệ thông tin</p>
                    <p>Chuyên đề ASP.NET</p>
                <p>SVTH: <br/>
                    Phạm Thị Yến Nhi - DA16TT <br/>
                    Tưởng Hoàng Tỷ -DA16TT
