<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TrangChuLoadControl.ascx.cs" Inherits="cms_display_TrangChu_TrangChuLoadControl" %>
 <div id="slideshow">
    ...
    <!-- This demo works without jquery library. -->
     ...
     <script src="../../../js/full-width-slider.slider/js/jssor.slider-21.1.5.min.js"></script>
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
                            ...
                            <div data-p="225.00" style="display: none;">                      
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/16.jpg" />
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">                              
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/15.jpg" />
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/17.jpg" />
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/13.jpg" />
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/12.jpg" />
                            </div>
                              <div data-p="225.00" data-po="80% 55%" style="display: none;">
                                <img data-u="image" src="../js/full-width-slider.slider/img/slider/15.jpg" />
                            </div>
       ...
       <%--<div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
                            ...
                            <div data-p="225.00" style="display: none;">                      
                                <img data-u="image"   img src="../../../pic/QuangCao/20.jpg" /> 
                             
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">                              
                                <img data-u="image"   src="../../../pic/QuangCao/20.jpg" />
                            </div>
                            <div data-p="225.00" data-po="80% 55%" style="display: none;">
                                <img data-u="image" src="../../../pic/QuangCao/1.jpg"  />
                            </div>
